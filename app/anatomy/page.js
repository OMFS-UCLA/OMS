...
const anatomyCards = [
  {
    topic: "Anatomy",
    title: "Head and Neck Landmarks",
    speaker: "Dr. E. Collins",
    duration: "46 min lecture",
    href: "/anatomy",
  ...
  },
  {
    ...
    speaker: "Dr. T. Morgan",
    duration: "39 min lecture",
    href: "/anatomy",
    image: "/logo2.png",
  },
  {
    topic: "Anatomy",
    title: "Facial Planes and Spaces",
    speaker: "Dr. N. Park",
    duration: "43 min lecture",
    href: "/anatomy",
...
export default function AnatomyPage() {
  ...
  const tags = useMemo(() => anatomyCards.map((card) => card.title), []);
    ...
    <main className="bg-gray-100 pb-16">
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-6 px-6 py-24 text-white md:flex-row md:items-end md:justify-between">
          <h1 className="text-5xl font-bold tracking-tight md:text-6xl">Anatomy</h1>
      ...
      <section className="mx-auto -mt-6 max-w-7xl px-4">
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-5 max-w-xl text-xl leading-relaxed text-gray-700">
                Explore core anatomical structures, regions, and relationships
                that support clinical decision-making and safe surgical practice.
              </p>
            </div>
        ...
        <LectureCards
          ...
          title="Anatomy Lectures"
          subtitle="Click any card to open a lecture. Update these sample cards with your own modules and destination links."
          cards={filteredCards}
        />
      </section>
    </main>
